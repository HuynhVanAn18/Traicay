...
<body>
                            ...
                            <div class="header__top__right__language">
                                ...
                                ?>
                                    ...
                                    <i class="fa fa-user"></i><a href="{{URL::to('/login-checkout')}}">
                                        <div style="margin-left: 5px;">{{__('Đăng Nhập')}}</div>
                                    </a>
                                <?php
                                }
                                ?>
                ...
                <div class="col-lg-3">
                    <div class="{{-- header__logo --}}">
                        <center> <a href="{{URL::to('/trang-chu')}}">
                                <image style="display: block;max-width:200px;max-height:150px;width: auto;height: auto;" src="{{URL::to('frontend/image/logo.png')}}" alt="">
                            </a></center>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="footer__about">
                        ...
                        <div class="footer__about__logo">
                            <a href="{{URL::to('/trang-chu')}}">
                                <image width="300" height="150" src="{{URL::to('upload/contact/'.$ci->info_logo)}}" alt="">
                            </a>
                        </div>
                        <ul>
    ...
    <script type="text/javascript">
        ...
        function add_wistlist(clicked_id) {
            ...
            if (matches.length) {
                alert('{{__('
                    Sản phẩm bạn đã yêu thích, nên không thể thêm ')}}');
        ...
        $(document).ready(function() {
            $('.send-order').click(function() {
                swal({
                    ...
                    function(isConfirm) {
                        if (isConfirm) { // if (shipping_method == 0) {
                                $.ajax({
